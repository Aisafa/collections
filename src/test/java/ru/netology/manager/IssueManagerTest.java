...
class IssueManagerTest {
    ...
    private Issue first = new Issue(1, "one", "description", true, "Aidar", "Ruslan", "Tools", "back", "bug");
    private Issue second = new Issue(2, "two", "description", false, "Natalya", "Alex","Gradle" , "front", "bug");
